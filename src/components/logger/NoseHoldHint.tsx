        ...
        <div className="flex flex-col items-center gap-1">
          ...
          {onDismiss ? (
            <button
              type="button"
              onClick={onDismiss}
              className="text-2xs font-medium text-text-muted underline decoration-text-muted/50 underline-offset-4 transition hover:text-text-primary hover:decoration-text-primary/60"
            >
