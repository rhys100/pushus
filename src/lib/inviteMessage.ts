...
export function buildInviteMessage(link: string): string {
  return [
    `You're invited to ${appConfig.name} — a private push-up app for you, your mates, and their mates. Log reps, bank your sets, and see how you're tracking on daily, weekly, and monthly leaderboards.`,
    '',
