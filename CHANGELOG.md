...
- **Activity icons:** custom activities use a minimal line-icon set themed to the app (barbell, kettlebell, pull-up bar, bolt, …) instead of emojis; push-ups is the brand bolt everywhere. Legacy emoji values still render
