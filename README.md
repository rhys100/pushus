...
- [x] Installable Android PWA manifest with app icons and an in-app install prompt
- [x] AGPL-3.0-only licence
- [x] Self-hostable Community mode
- [x] Optional web push reminders (behind goal, user timezone, configurable frequency; installable app path for more reliable Android delivery)
